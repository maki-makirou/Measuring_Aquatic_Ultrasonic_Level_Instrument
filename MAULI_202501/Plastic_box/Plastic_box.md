...
1. 本体と扉の接続部が分離しづらくなるようにジョイント部の穴に楊枝を金槌で打ち込みます。（私が考案した方法です。穴の使い方を間違っているかも？）
...
5. 超音波式距離センサーを嵌め込む箇所（写真の2箇所）をカッターやラジオペンチを使って取り除きます。
