...
また、以下のサイトから、[lcd_api.py](https://github.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/blob/main/MAULI_202501/lcd_api.py) と [pico_i2c_lcd.py](https://github.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/blob/main/MAULI_202501/pico_i2c_lcd.py) をそれぞれ取得して同じ名前（lcd_api.py，pico_i2c_lcd.py）で Raspberry Pi Pico 内部の main.py と同じフォルダに置いてください。
