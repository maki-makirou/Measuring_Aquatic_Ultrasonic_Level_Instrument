...
正常な場合は、画面のようになります。**但し、初回起動時は log.csv はありません。一度https://github.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/blob/main/MAULI_202501/MAULI_20250113.py計測すると log.csv が現れます。** 
