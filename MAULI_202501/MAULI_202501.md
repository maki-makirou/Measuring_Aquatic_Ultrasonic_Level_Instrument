...
|11|スーパービバホーム|桧工作材　5x30x900|¥408|2024/10|5x60x???のサイズあればそちらの方が良い。2台目以降は当分購入不要|
...
以下のコードを main.py にリネームして Raspberry Pi Pico に書き込んでください。
...
3 [プラボックス組み込み](https://github.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/blob/main/MAULI_202501/Assemble/Assemble.md)
