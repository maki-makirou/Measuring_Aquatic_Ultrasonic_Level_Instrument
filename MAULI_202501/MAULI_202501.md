...
## 作り方
### はじめに
[以下のサイト](https://osoyoo.com/ja/2021/07/14/raspberry-pi-pico-learning-kit-lesson-1-getting-started-with-micropython/)などを参考にしてファームウェアを導入し、 Thonny をインストールして動作確認してください。
