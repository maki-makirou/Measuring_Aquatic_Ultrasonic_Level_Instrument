...
**※1/25講習会にオンライン参加される方は、1〜5、7、10 をご準備ください。**
...
|11|スーパービバホーム|桧工作材　5x30x900|¥408|2024/10|最終的に必要なサイズは 5x60x80 です。[写真](https://raw.githubusercontent.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/refs/heads/main/MAULI_202501/Woodworking/img/IMG_4892.JPG?token=GHSAT0AAAAAACXPSFN76GNZXI7FAZEWYZFWZZUVW7Q)　※1|
|12|スーパービバホーム|ピン釘（20x13mm）|¥138|2024/11|[写真](https://raw.githubusercontent.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/refs/heads/main/MAULI_202501/Woodworking/img/IMG_6449.JPG?token=GHSAT0AAAAAACXPSFN7C2NX7TWZIJAO2OWSZZUVS2A)　※1|
|13|スーパービバホーム|ステンレス建具用木ねじ皿（2x19mm）|¥228|2024/11|[写真](https://raw.githubusercontent.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/refs/heads/main/MAULI_202501/Woodworking/img/IMG_6419.JPG?token=GHSAT0AAAAAACXPSFN7JTS7NUH5CZLMLJ2UZZUVTMQ)　※1|
|14|スーパービバホーム|ピン釘（20x19mm）|¥138|2024/11|[写真](https://raw.githubusercontent.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/refs/heads/main/MAULI_202501/Woodworking/img/IMG_6335.JPG?token=GHSAT0AAAAAACXPSFN7ZEHAJNQIFAEUHB3MZZUVT6Q)　※1|
...
超音波センサーについて、右側が3.3V仕様の2020年型です。左側はそれより以前の5V仕様のもので今回の配線では動きません。似ているのでご注意ください。リンク先のものを購入することをおすすめします。
...
## 作り方
### はじめに
[以下のサイト](https://osoyoo.com/ja/2021/07/14/raspberry-pi-pico-learning-kit-lesson-1-getting-started-with-micropython/)などを参考にして、PC に Thonny をインストールして動作確認してください。また、[ファームウェア(RPI_PICO-20240602-v1.23.0.uf2)](https://github.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/blob/main/MAULI_202501/RPI_PICO-20240602-v1.23.0.uf2)をRaspberry Pi Pico に書き込んでください。（サンプルコード [Lチカ](https://github.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/blob/main/MAULI_202501/L_Chika.py)）
...
|部品|機能|接続先|ブレッドボードNo.|No.|
|-------|---|---|--|--|
|HC-SR04|VCC|3V3|右5|36|
|HC-SR04|TRIG|GP0|左1|1|
|HC-SR04|ECHO|GP1|左2|2|
|HC-SR04|GND|GND|左3|3|
|LCD1602I2C|GND|GND|右18|23|
|LCD1602I2C|VCC|VBUS|右1|40|
|LCD1602I2C|SDA|GP16|右20|21|
|LCD1602I2C|SCL|GP17|右19|22|
...
配線作業完了後、このようになります。**ここで接着剤（ボンド ウルトラ多用途S・U プレミアムソフト クリヤー 25ml）でワイヤーをブレッドボードに差し込んだ箇所を固定してください。風等の衝撃で抜けにくくなります。**

<br>

### プログラム
以下のコードを main.py にリネームして Raspberry Pi Pico に書き込みます。Thonny で開いてください。
...
また、以下のサイトから、[lcd_api.py](https://github.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/blob/main/MAULI_202501/lcd_api.py) と [pico_i2c_lcd.py](https://github.com/maki-makirou/Measuring_Aquatic_Ultrasonic_Level_Instrument/blob/main/MAULI_202501/pico_i2c_lcd.py) を取得して Raspberry Pi Pico 内部の main.py と同じフォルダに置いてください。
https://github.com/T-622/RPI-PICO-I2C-LCD

正常な場合は、画面のようになります。**但し、初回起動時は log.csv はありません。一度計測すると log.csv が現れます。** 
