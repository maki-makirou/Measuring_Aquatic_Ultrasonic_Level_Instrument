...
2 初期設定では電源を入れて1分後から記録を開始します。電池をセットし、時計を見ながら 00 秒ちょうどに電源を入れてください。忘れないうちに1分後の時刻をメモしてください。

3 屋外で使用する場合は、風等の衝撃で電池が外れることがあります。電池が外れないようにセロハンテープで固定してください。

4 水位計の設置地点の水深をmm単位で測り、メモしてください。

<br>

### 回収時

1 水位計を回収したら　PC に接続して Thonny を起動して、ラズパイ pico 内の「log.csv」ファイルを開いてデータをコピーしてください。
